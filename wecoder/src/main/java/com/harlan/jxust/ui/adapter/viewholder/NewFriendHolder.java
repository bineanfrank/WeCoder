...
import com.harlan.jxust.Config;
import com.harlan.jxust.bean.AgreeAddFriendMessage;
...
import com.harlan.jxust.utils.GlideLoader;
...
public class NewFriendHolder extends BaseViewHolder {
    ...
    public SuperImageView iv_recent_avater;
    ...
    public NewFriendHolder(Context context, ViewGroup root, OnRVClickListener onRecyclerViewListener) {
...
//        ViewUtil.setAvatar(add == null ? null : add.getAvatar(), R.mipmap.head, iv_recent_avatar);
        iv_recent_avater.loadImage(add.getAvatar(), false, R.drawable.default_avatar);
        //会话标题
