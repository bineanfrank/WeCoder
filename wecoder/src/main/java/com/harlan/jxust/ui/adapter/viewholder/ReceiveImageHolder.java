...
public class ReceiveImageHolder extends BaseViewHolder {
    ...
    public ReceiveImageHolder(Context context, ViewGroup root, OnRVClickListener onRecyclerViewListener) {
        super(context, root, R.layout.item_chat_received_picture, onRecyclerViewListener);
    }
    ...
    public void bindData(Object o) {
        ...
        //显示图片
        siv_picture.loadImageFixedSize(message.getRemoteUrl(), R.drawable.default_image, 320, 450);
